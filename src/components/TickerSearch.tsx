    ...
    <form onSubmit={submit} className="w-full sm:w-auto">
      <div className="flex gap-2">
        <input
          ...
          dir="ltr"
          className="num w-full rounded-lg border border-line bg-surface px-3 py-2 text-sm text-ink placeholder:text-ink-faint focus:border-line-strong focus:outline-none sm:w-40"
        />
        <button
          type="submit"
